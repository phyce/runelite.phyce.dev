...
.app-header__inner {
    @apply mx-auto flex w-full max-w-screen-2xl items-center gap-4 px-4 py-3;
}

/* Brand */
.app-header__brand {
    @apply flex flex-shrink-0 items-center gap-3 no-underline;
}
...
.app-header__title {
    @apply whitespace-nowrap text-lg font-light tracking-wide text-white;
}
