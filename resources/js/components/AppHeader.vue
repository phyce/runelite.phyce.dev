    ...
    <header class="app-header">
        <div class="app-header__inner">
            ...
            <div class="app-header__controls">
                <button
                    class="app-header__random-btn"
                    title="Jump to a random plugin"
                    @click="navigateRandom"
                >
                    <svg
                        class="app-header__random-icon"
                        width="16"
                        height="16"
                ...
                <div class="app-header__search">
                    ...
                    >
                        ...
                        >
                            <span class="app-header__search-result-name">{{
                                plugin.display || plugin.name
                            }}</span>
                            <span
                                v-if="plugin.author"
                                class="app-header__search-result-author"
                                >{{ plugin.author }}</span
                            >
                        </a>
                    </div>
            ...
            <div class="app-header__mobile-actions">
                ...
                <button
                    class="app-header__random-btn app-header__random-btn--mobile"
                    title="Jump to a random plugin"
                    @click="navigateRandom"
                >
                    <svg
            ...
            <div v-if="menuOpen" class="app-header__drawer">
                ...
                <div class="app-header__drawer-search">
                    ...
                    <div
                        ...
                        class="app-header__drawer-results"
                    >
                        <a
                            v-for="plugin in searchResults"
                            :key="plugin.id"
        ...
        <a
            ...
            class="app-header__github-corner"
        ...
        >
            <svg
                ...
                height="80"
                viewBox="0 0 250 250"
                class="app-header__github-corner-svg"
                aria-hidden="true"
            >
                <path
...
.app-header__brand {
    @apply flex min-w-0 flex-1 items-center gap-3 no-underline sm:flex-none sm:shrink-0;
}

.app-header__logo {
    @apply block shrink-0 rounded;
...
.app-header__random-btn {
    @apply flex shrink-0 items-center gap-2 rounded-md border border-orange-700/60 bg-orange-800/40 px-3 py-2 text-sm font-medium text-orange-200 transition-colors hover:border-orange-600 hover:bg-orange-700/60 hover:text-white active:bg-orange-800;
}
...
.app-header__search-input {
    @apply w-full rounded-md border border-neutral-600/70 bg-neutral-800 py-2 pr-3 pl-9 text-sm text-white placeholder:text-neutral-500 focus:border-orange-600/70 focus:ring-1 focus:ring-orange-600/50 focus:outline-none;
}
...
.app-header__search-results::-webkit-scrollbar-track {
    background: #262626;
}
...
.app-header__mobile-actions {
    @apply flex shrink-0 flex-col gap-1.5 sm:hidden;
}
...
.app-header__drawer-title {
    @apply text-sm font-semibold tracking-widest text-neutral-300 uppercase;
}
