...
import type { RankedPlugin, SharedInertiaProps, Top100Metrics } from '@/types';
...
<template>
    <Head>
        <title>Top 100 RuneLite Plugins | RuneLite Plugin Stats</title>
    </Head>

    <div class="top100">
        <div class="top100__header">
            <h1 class="top100__title">Current Top Plugins</h1>
            <p class="top100__subtitle">
                Ranked by popularity, growth, player retention, and various
                other metrics.
            </p>
        </div>
        ...
        <div v-else class="top100__content">
            <!-- #1 -->
            <div
                v-if="podiumEntries[0]"
                class="top100__card top100__card--gold"
            >
                ...
                <div class="top100__card-body">
                    ...
                    >
                    <span
                        v-if="podiumEntries[0].plugin.author"
                        class="top100__card-author top100__card-author--gold"
                    >
                        by {{ podiumEntries[0].plugin.author }}
                    </span>
                    <div
                        class="top100__card-installs top100__card-installs--gold"
                    >
                        {{
                            formatNumber(
                                podiumEntries[0].plugin.current_installs,
                            )
                        }}
                        <span
                            class="top100__card-installs-label top100__card-installs-label--gold"
                            >installs</span
                        >
                    </div>
                </div>
                <a
                    :href="show.url(podiumEntries[0].plugin.name)"
                    class="top100__card-stats top100__card-stats--gold"
                    >Stats</a
                >
            </div>
            ...
            <!-- #2 -->
            <div
                v-if="podiumEntries[1]"
                class="top100__card top100__card--silver"
            >
                ...
                <div class="top100__card-body">
                    ...
                    >
                    <span
                        v-if="podiumEntries[1].plugin.author"
                        class="top100__card-author top100__card-author--silver"
                    >
                        by {{ podiumEntries[1].plugin.author }}
                    </span>
                    <div
                        class="top100__card-installs top100__card-installs--silver"
                    >
                        {{
                            formatNumber(
                                podiumEntries[1].plugin.current_installs,
                            )
                        }}
                        <span
                            class="top100__card-installs-label top100__card-installs-label--silver"
                            >installs</span
                        >
                    </div>
                </div>
                <a
                    :href="show.url(podiumEntries[1].plugin.name)"
                    class="top100__card-stats top100__card-stats--silver"
                    >Stats</a
                >
            </div>
            ...
            <!-- #3 -->
            <div
                v-if="podiumEntries[2]"
                class="top100__card top100__card--bronze"
            >
                ...
                <div class="top100__card-body">
                    ...
                    >
                    <span
                        v-if="podiumEntries[2].plugin.author"
                        class="top100__card-author top100__card-author--bronze"
                    >
                        by {{ podiumEntries[2].plugin.author }}
                    </span>
                    <div
                        class="top100__card-installs top100__card-installs--bronze"
                    >
                        {{
                            formatNumber(
                                podiumEntries[2].plugin.current_installs,
                            )
                        }}
                        <span
                            class="top100__card-installs-label top100__card-installs-label--bronze"
                            >installs</span
                        >
                    </div>
                </div>
                <a
                    :href="show.url(podiumEntries[2].plugin.name)"
                    class="top100__card-stats top100__card-stats--bronze"
                    >Stats</a
                >
            </div>
                ...
                >
                    ...
                    <div class="top100__list-plugin">
                        ...
                        <span
                            ...
                            class="top100__list-author"
                            >by {{ entry.plugin.author }}</span
                        >
                    </div>
                    <span class="top100__list-installs"
                        >{{
...
.top100__content {
    @apply -mx-4 flex flex-col gap-3 sm:mx-0;
}
...
.top100__card-rank--gold {
    @apply shrink-0 text-7xl leading-none font-bold tabular-nums;
    color: #ffd700;
}

.top100__card-name--gold {
    @apply truncate text-2xl leading-tight font-bold;
    color: #fff8c0;
...
.top100__card-rank--silver {
    @apply shrink-0 text-5xl leading-none font-bold tabular-nums;
    color: #e2e8f0;
}

.top100__card-name--silver {
    @apply truncate text-xl leading-tight font-bold;
    color: #f1f5f9;
    transition: color 0.1s;
}
...
.top100__card-rank--bronze {
    @apply shrink-0 text-4xl leading-none font-bold tabular-nums;
    color: #e8724a;
}

.top100__card-name--bronze {
    @apply truncate text-lg leading-tight font-semibold;
    color: #f0a888;
    transition: color 0.1s;
}
...
.top100__list-rank {
    @apply shrink-0 text-right text-sm font-medium text-gray-300 tabular-nums;
}

.top100__list-plugin {
    @apply flex min-w-0 flex-1 flex-col gap-0;
}
...
.top100__list-installs {
    @apply shrink-0 text-right text-sm text-gray-300 tabular-nums;
}
