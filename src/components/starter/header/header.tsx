		...
		<header class="flex items-center px-4 py-3">
			...
			<div class="flex ml-auto mr-auto items-center space-x-2 relative">
				<button
					...
					class="min-w-44 inline-flex items-center justify-center rounded text-sm bg-orange-700 h-10 px-2 py-1 rounded">
					Random Plugin
					<svg
						class="ml-2"
						width="28"
				...
				<div class="relative flex w-full">
					<input class="flex-1 h-10 min-w-96 w-full border border-input px-3 py-2 disabled:opacity-50 rounded text-black ring-2 focus:ring-orange-500"
